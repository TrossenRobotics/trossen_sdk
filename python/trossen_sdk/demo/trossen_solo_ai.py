...
#
# Hardware setup:
# 1. Two WXAI V0 arms (leader + follower) connected via Ethernet
# 2. Two RealSense cameras
#
# Usage:
#   python -m trossen_sdk.demo.trossen_solo_ai
#   python -m trossen_sdk.demo.trossen_solo_ai --config path/to/config.json
...
def main():
    parser = argparse.ArgumentParser(description="Trossen Solo AI Data Collection")
    parser.add_argument(
        "--config",
    ...
    ts.print_config_banner("Trossen Solo AI Kit (Python)", config_lines)
