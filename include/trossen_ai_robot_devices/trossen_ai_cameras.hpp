...
/// @brief Data structure to hold image data from the camera including depth map
/// if available in OpenCV Mat format
struct ImageData {
...
/// @brief Data structure to hold the image(cv::Mat) and the filename where it
/// should be saved
 ...
 * This class provides methods to connect to the camera, disconnect, and read
 * frames It supports both color images and depth maps, and can be configured
 * for resolution and frame rate
 */
