 ...
 * This structure holds the configuration parameters for a camera including its
 * name, serial number, frames per second, resolution, and whether to use depth.
 */
struct CameraConfig {
 ...
 * This class serves as a base for specific robot configurations, providing a
 * virtual destructor and a method to get the robot's name.
 */
 ...
 * This class serves as a base for specific leader robot configurations,
 * providing a virtual destructor and a method to get the leader robot's name.
 */
 ...
 * This structure holds the configuration parameters for a WidowX robot
 * including its name and IP address. It inherits from LeaderConfigBase.
 */
 ...
 * This structure holds the configuration parameters for a Bimanual WidowX robot
 * including its name, IP addresses for both arms, and camera configurations. It
 * inherits from RobotConfigBase.
 */
 ...
 * This structure holds the configuration parameters for a Bimanual WidowX
 * leader and follower robots including its name, IP addresses for both arms,
 * and camera configurations. It inherits from LeaderConfigBase.
 */
...
struct BimanualWidowXRobotConfig : public RobotConfigBase {
  ...
  std::vector<CameraConfig>
      cameras;  // Camera configuration for the follower arm
};
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(BimanualWidowXLeaderConfig, name,
                                   left_ip_address, right_ip_address)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(BimanualWidowXRobotConfig, name,
                                   left_ip_address, right_ip_address,
                                   camera_interface, cameras)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(WidowXLeaderConfig, name, ip_address)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(WidowXRobotConfig, name, ip_address,
                                   camera_interface, cameras)
