...
struct ActiveSession {
    ...
    std::vector<std::shared_ptr<SO101ArmDriver>>
        arm_drivers;
    std::vector<std::shared_ptr<trossen_arm::TrossenArmDriver>>
        widowx_drivers;
    ...
    std::atomic<bool> all_episodes_complete;
    std::atomic<bool> paused;
    std::atomic<bool> waiting_for_next;
    bool teleop_active;
    bool episode_manager_active;
