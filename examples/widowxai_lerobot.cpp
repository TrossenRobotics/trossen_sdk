...
int main(int argc, char** argv) {
  ...
  session_cfg.backend_config.task_name = "trossen_ai_solo_demo";
  session_cfg.backend_config.repository_id = "TrossenRoboticsCommunity";
  session_cfg.backend_config.dataset_name = "trossen_ai_solo_dataset";
  session_cfg.backend_config.overwrite_existing = false;
  session_cfg.backend_config.encode_videos = true;
  ...
  std::shared_ptr<trossen::hw::PolledProducer> camera_producer2;
  ...
  if (cfg.use_mock) {
    ...
    cam_cfg.stream_id = "camera_wrist";
    ...
    trossen::hw::camera::MockCameraProducer::Config cam_cfg2;
    cam_cfg2.width = cfg.camera_width;
    cam_cfg2.height = cfg.camera_height;
    cam_cfg2.fps = cfg.camera_fps;
    cam_cfg2.stream_id = "camera_main";
    cam_cfg2.encoding = "bgr8";
    cam_cfg2.pattern = trossen::hw::camera::MockCameraProducer::Pattern::Gradient;
    cam_cfg2.warmup_frames = 3;
    camera_producer2 = std::make_shared<trossen::hw::camera::MockCameraProducer>(cam_cfg2);
    std::cout << "  ✓ Mock camera 2 producer (" << cfg.camera_fps << " Hz, "
              << cfg.camera_width << "x" << cfg.camera_height << ")\n";
  } else {
  ...
  mgr.add_producer(camera_producer2, camera_period);
